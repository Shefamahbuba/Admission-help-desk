...
if(isset($_POST['payment'])){
    ...
    $sql = "INSERT into booked (cust_name,cust_email,cust_contact,no_of_rooms,hotel,check_in,check_out,price)
               values ('$user_name','$email','$contact_no','$no_of_rooms','$hotel','$check_in','$check_out','$price*$no_of_rooms')";
...
$post_data['total_amount'] 		= $price*$no_of_rooms;
